...
pModel::pModel(SDL_Renderer *gRenderer_from_main, const int wFromMain,
               const int hFromMain) {
  // Pass ptrs
...
void pModel::updatePendulum(double theta, double theta2) {
  ...
  pt1 = {(int)(pt0.x + pLen * sin(theta) + 0.5),
         (int)(pt0.y + pLen * cos(theta) + 0.5)};
  pt2 = {(int)(pt1.x + pLen * sin(theta2) + 0.5),
         (int)(pt1.y + pLen * cos(theta2) + 0.5)};
}
